...
const FooterSection = () => {
  ...
  return (
    <footer className="bg-[#202020] text-white font-body">
      <div className="max-w-[1440px] mx-auto px-8 md:px-16 lg:px-[calc((100%-1418px)/2+16px)] pt-10 pb-16">

        {/* Navigation Links Row */}
        <div className="flex flex-wrap items-center justify-between gap-6 mb-10">
          <Link href="/company" className="text-[#C0BFBF] text-lg md:text-xl hover:text-white transition-colors">
            Company
          </Link>
          <Link href="/become-distributor" className="text-[#C0BFBF] text-lg md:text-xl hover:text-white transition-colors">
            Collaborate
          </Link>
          <a href="mailto:info@edrive-jetcar.com" className="text-[#C0BFBF] text-lg md:text-xl hover:text-white transition-colors">
            Contact Us
          </a>
          <Link href="/investors" className="text-[#C0BFBF] text-lg md:text-xl hover:text-white transition-colors">
            Privacy & Legal
          </Link>
          <Link href="/company/careers" className="text-[#C0BFBF] text-lg md:text-xl hover:text-white transition-colors">
            Careers
          </Link>
        </div>
        ...
        {/* Follow Us Section */}
        <div className="mb-6">
          <p className="text-white text-xl md:text-2xl mb-6">Follow us on :</p>
          <div className="flex flex-wrap items-center gap-8 md:gap-12 lg:gap-16">
            <a href="https://www.instagram.com/edrive.jetcar?igsh=Y3pqY3ZoY243NDRj" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white hover:text-white/70 transition-colors">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="5" /><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor" stroke="none" /></svg>
            ...
            <a href="https://www.facebook.com/profile.php?id=100093972499250" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white hover:text-white/70 transition-colors">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
            ...
            <a href="https://www.linkedin.com/company/emotion-drive" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white hover:text-white/70 transition-colors">
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect x="2" y="9" width="4" height="12" /><circle cx="4" cy="4" r="2" /></svg>
        ...
        {/* Legal Notice 1 */}
        <div className="mb-8">
          <h4 className="text-white text-xl md:text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>LEGAL NOTICE</h4>
          <p className="text-[#B4B4B4] text-base md:text-xl leading-[1.35]">
        ...
        {/* Copyright */}
        <div>
          <h4 className="text-white text-xl md:text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-heading)' }}>COPYRIGHT</h4>
          <p className="text-[#B4B4B4] text-base md:text-xl leading-[1.35]">
